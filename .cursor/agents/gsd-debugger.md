...
<required_reading>
@D:/Fontes/peladas/.cursor/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/Fontes/peladas/.cursor/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Fontes/peladas/.cursor
                  → checks D:/Fontes/peladas/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Fontes/peladas/.cursor/get-shit-done
                  → writes to D:/Fontes/peladas/.cursor/get-shit-done/hooks/
...
@D:/Fontes/peladas/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Fontes/peladas/.cursor/get-shit-done/references/common-bug-patterns.md
