...
Reference full template: `D:/Fontes/peladas/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Fontes/peladas/.cursor/get-shit-done/templates/state.md`.
