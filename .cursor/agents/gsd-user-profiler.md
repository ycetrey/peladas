...
<reference>
@D:/Fontes/peladas/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Fontes/peladas/.cursor/get-shit-done/references/user-profiling.md` to load:
