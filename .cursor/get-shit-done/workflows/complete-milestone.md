...
```bash
node "D:/Fontes/peladas/.cursor/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/Fontes/peladas/.cursor/get-shit-done/templates/retrospective.md`.
