...
```
Task(
  prompt="Read D:/Fontes/peladas/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Fontes/peladas/.cursor/get-shit-done/templates/SECURITY.md`
