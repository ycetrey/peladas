...
```markdown
Read D:/Fontes/peladas/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Fontes/peladas/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Fontes/peladas/.cursor/agents/gsd-ui-checker.md for instructions.
