...
```bash
INIT=$(node "D:/Fontes/peladas/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Fontes/peladas/.cursor/get-shit-done/templates/spec.md.
